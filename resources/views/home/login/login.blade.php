                ...
                <label for="remember-me"><input id="remember-me" type="checkbox">记住密码</label>
						...
						<div class="partner">		
							...
							<div class="am-btn-group">
								<li><a href="/h/#"><i class="am-icon-qq am-icon-sm"></i><span>QQ登录</span></a></li>
								<li><a href="/h/#"><i class="am-icon-weibo am-icon-sm"></i><span>微博登录</span> </a></li>
								<li><a href="/h/#"><i class="am-icon-weixin am-icon-sm"></i><span>微信登录</span> </a></li>
							</div>
						</div>	
						</form>
				</div>
