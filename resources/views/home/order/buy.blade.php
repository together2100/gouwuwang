								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="{{ $data['pic'] }}" width="80px" height="80px" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">{{ $data['name'] }}</a>
														</div>
													</div>
												</li>
												<li class="td td-info">
												...
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<em class="J_Price price-now">￥{{ $data['price'] }} 元</em>
														</div>
													</div>
												</li>
											</div>
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															<input class="text_box" name="" type="text" value="{{ $data['num'] }}" style="width:30px;" />
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number">总计：{{ $data['num']*$data['price'] }}元</em>
												</div>
											</li>
						...
						<!--留言-->
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
									...
									<input type="hidden" name="total" value="{{ $data['num']*$data['price'] }}">
