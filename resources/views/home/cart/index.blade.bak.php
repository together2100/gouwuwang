						...
						<div class="bundle  bundle-last">
							<div class="bundle-main">
								<ul class="item-content clearfix">
									...
									<li class="td td-item">
										<div class="item-pic">
											<a href="/h/#" target="_blank" data-title="美康粉黛醉美东方唇膏口红正品 持久保湿滋润防水不掉色护唇彩妆" class="J_MakePoint" data-point="tbcart.8.12">
												<img src="{{ $row['pic'] }}" width="80px" height="80px" class="itempic J_ItemImg"></a>
										</div>
										<div class="item-info">
											<div class="item-basic-info">
                                                <a href="/h/#" target="_blank" title="" class="item-title J_MakePoint" data-point="tbcart.8.11">
                                                 {{ $row['name'] }}</a>
											</div>
										</div>
									</li>
									<li class="td td-info">
                                        {!!$row['descr']!!}
										<div class="item-props item-props-can" style="display:none;">
										...
										<div class="amount-wrapper ">
											<div class="item-amount ">
												<div class="sl">
													...
													<input class="text_box number" name="" type="text" value="{{ $row['num'] }}" style="width:30px;" />
													<input class="add am-btn numup" name="" type="button" value="+" />
												</div>
											</div>
										</div>
									</li>
									<li class="td td-sum">
										<div class="td-inner">
											<em tabindex="0" class="J_ItemSum number">总计：{{ $row['price']*$row['num'] }}元</em>
										</div>
									</li>
									<li class="td td-op">
										<div class="td-inner">
											<a title="移入收藏夹" class="btn-fav" href="/h/#">移入收藏夹</a>
