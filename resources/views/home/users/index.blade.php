...
@section('main')
						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-right">
										<div class="m-new">
											<a href="/h/news.html"><i class="am-icon-bell-o"></i>消息</a>
										</div>
										<div class="m-address">
											<a href="/h/address.html" class="i-trigger">我的收货地址</a>
										</div>
									</div>
								</div>
							...
							<div class="m-order">
								<div class="s-bar">
									...
									<a class="i-load-more-item-shadow" href="/h/order.html">全部订单</a>
								</div>
								<ul>
									<li><a href="/h/order.html"><i><img src="/h/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="/h/order.html"><i><img src="/h/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="/h/order.html"><i><img src="/h/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="/h/order.html"><i><img src="/h/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="/h/change.html"><i><img src="/h/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
							</div>
							<!--九宫格-->
							<div class="user-patternIcon">
								...
								<ul>
									...
									<a href="/h/home/shopcart.html"><li class="am-u-sm-4"><i class="am-icon-shopping-basket am-icon-md"></i><img src="/h/images/iconbig.png"/><p>购物车</p></li></a>
									<a href="/h/collection.html"><li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i><img src="/h/images/iconsmall1.png"/><p>我的收藏</p></li></a>
									<a href="/h/home/home.html"><li class="am-u-sm-4"><i class="am-icon-gift am-icon-md"></i><img src="/h/images/iconsmall0.png"/><p>为你推荐</p></li></a>
									<a href="/h/comment.html"><li class="am-u-sm-4"><i class="am-icon-pencil am-icon-md"></i><img src="/h/images/iconsmall3.png"/><p>好评宝贝</p></li></a>
									<a href="/h/foot.html"><li class="am-u-sm-4"><i class="am-icon-clock-o am-icon-md"></i><img src="/h/images/iconsmall2.png"/><p>我的足迹</p></li></a>                                                                        
								</ul>
							</div>
							<!--物流 -->
										...
										<li class="lg-item">
											...
											<div class="lg-info">
												...
												<div class="lg-detail-wrap">
													<a class="lg-detail i-tip-trigger" href="/h/logistics.html">查看物流明细</a>
													...
													<div class="J_TipsCon hide">
														...
														<div class="s-tip-content">
															<ul>
																...
																<li class="s-omit"><a data-spm-anchor-id="a1z02.1.1998049142.7" target="_blank" href="/h///wuliu.taobao.com/user/order_detail_new.htm?spm=a1z02.1.1998049142.7.8BJBiJ&amp;trade_id=1479374251166800&amp;seller_id=1651462988&amp;tracelog=yimaidaologistics">··· 查看全部</a></li>
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="/h/home/home.html"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="/h/home/sort.html"><i class="am-icon-list"></i>分类</a></li>
			<li><a href="/h/home/shopcart.html"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
			<li class="active"><a href="/h/index.html"><i class="am-icon-user"></i>我的</a></li>					
		</div>
@endsection