					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="{{ $data->pic }}"><img src="{{ $data->pic }}" alt="细节展示放大镜特效" rel="{{ $data->pic }}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="{{ $data->pic }}" mid="{{ $data->pic }}" big="{{ $data->pic }}"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
								...
								<dd>
									...
									<div class="theme-popover">
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="/homeorderbuy" method="post">
                                                {{ csrf_field() }}
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<span id="Stock" class="tb-hidden">库存<span class="stock">{{ $data->num }}</span>件</span>
														</dd>
                            ...
                            <div class="pay">
                                ...
                                <li>
                                    <div class="clearfix tb-btn tb-btn-buy theme-login">
                                        <!-- <a id="LikBuy" title="点此按钮到下一步确认购买信息" href="" class="btn">立即购买</a> -->
