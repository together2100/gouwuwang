...
$options['accountsid']='28699239994f718740f3deee97f4f9a7';
//填写在开发者控制台首页上的Auth Token
$options['token']='28bc4774d1f6afd5741d261a39baeacb';

//初始化 $options必填
$ucpass = new Ucpaas($options);


$appid = "2339777131e14f6fa4fee10863d363cd";	//应用的ID，可在开发者控制台内的短信产品下查看
$templateid = "513804";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
$param = rand(1,10000); //多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则留空
$mobile = $phone; // 接受号码
$uid = "";
Cookie::queue('pcode', $param, 5); // 把收到的手机验证码存在cookie
